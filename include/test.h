...
class HelloTriangleApplication {
    ...
    private:
        ...
        void initVulkan() {
            ...
            std::cout << "depthResources created\n";
            createFramebuffers();
            std::cout << "Framebuffers created\n";
            createTextureImage();
            std::cout << "textureImage created\n";
            createTextureImageView();
            std::cout << "textureImageView created\n";
            createTextureSampler();
            std::cout << "textureSampler created\n";
            createVertexBuffer();
        ...
        static VKAPI_ATTR VkBool32 VKAPI_CALL debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageType, const VkDebugUtilsMessengerCallbackDataEXT* pCallbackData, void* pUserData) {
            if (messageSeverity >= VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT) {
                std::cerr << "Panic: " << pCallbackData->pMessage << "\n";
            }
        ...
        void createSwapChain() {
            ...
            // imageUsage can change if you want to make some post-processing to
            // the image
            ...
            // In the case of a window resizing, you have to delete de old swap
            // and create a new one. For now, we'll suppose the window won't be
            // resized
        ...
        void createDescriptorPool() {
            ...
            if (vkCreateDescriptorPool(device, &poolInfo, nullptr, &descriptorPool) != VK_SUCCESS) {
                throw std::runtime_error("Failed to craete descriptor pool!");
            }
        }
        ...
        void createTextureImage() {
            ...
            stbi_uc* pixels = stbi_load("../textures/gotta-go-fast.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
